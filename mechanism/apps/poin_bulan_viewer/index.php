...
<html>
    <head>
        ...
        include "../../../data/pindahIKIPViewer.php";
        include "../../../data/pindahIKUKPViewer.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">View Poin Pegawai Bulan: <?php echo $_SESSION['waktu']?></li>
                                </ul>
                                ...
                                <tbody>
                                    <?php
                                    include "../../../data/view/daftarPoinPegawaiViewViewer.php";
                                    ?>
                                </tbody>
                            </table>
