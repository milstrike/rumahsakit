...
<html>
    <head>
        ...
        include "../../../data/editLevelKoordinasi.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Manajemen Koordinasi</li>
                                </ul>  
                                ...
                                <tbody>
                                    <?php
                                    include "../../../data/view/levelKoordinasiView.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../data/view/editLevelKoordinasiViewModal.php";
                            ?>
                        </div>
                    </div>
                </div>
