...
<html>
    <head>
        ...
        include "../../../data/IKIPSum.php";
        include "../../../data/nilaiIKIP.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Indeks Kinerja Individual Pegawai(IKIP)</li>
                                </ul>
                                ...
                                <thead>
                                    <tr id="theadBasic">
                                        ...
                                        <td colspan="2" id="thead" style="vertical-align: middle;">Target Kinerja Individu</td>
                                ...
                                <tbody>
                                    <?php
                                    include "../../../data/view/masterIKIPViewOnly.php";
                                    ?>
                                </tbody>
                            </table>
