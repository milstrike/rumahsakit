...
<html>
    <head>
        ...
        include "../../../data/tambahKelompok.php";
        include "../../../data/editKelompok.php";
        include "../../../data/deleteKelompok.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Manajemen Kelompok</li>
                                </ul>
                            
                                <p align="right">
                                    <a href="#tambah" data-toggle='modal'><button type="submit" class="btn btn-small"><i class="icon-plus-sign"></i>&nbsp;Tambah Kelompok</button></a>                                
                                </p>    
                                ...
                                <thead>
                                    <tr id="theadBasic">
                                        ...
                                        <td width="60%" id="thead">Kelompok</td>
                                        <td width="30%" id="thead">Aksi</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    include "../../../data/view/kelompokView.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../data/view/tambahKelompokViewModal.php";
                                include "../../../data/view/editKelompokViewModal.php";
                                include "../../../data/view/deleteKelompokModal.php";
                            ?>
                        </div>
                    </div>
                </div>
