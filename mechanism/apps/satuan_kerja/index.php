...
<html>
    <head>
        ...
        include "../../../data/tambahSatker.php";
        include "../../../data/editSatker.php";
        include "../../../data/deleteSatker.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Manajemen Satuan Kerja</li>
                                </ul>
                            
                                <p align="right">
                                    <a href="#tambah" data-toggle='modal'><button type="submit" class="btn btn-small"><i class="icon-plus-sign"></i>&nbsp;Tambah Satuan Kerja</button></a>                                
                                </p>    
                                ...
                                <thead>
                                    <tr id="theadBasic">
                                        ...
                                        <td width="60%" id="thead">Satuan Kerja</td>
                                        <td width="30%" id="thead">Aksi</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    include "../../../data/view/satkerView.php";
                                    ?>
                                </tbody>
                            </table>
                            
                            <?php
                                include "../../../data/view/tambahSatkerViewModal.php";
                                include "../../../data/view/editSatkerViewModal.php";
                                include "../../../data/view/deleteSatkerModal.php";
                            ?>
                        </div>
                    </div>
                </div>
