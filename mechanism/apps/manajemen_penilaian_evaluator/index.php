...
<html>
    <head>
      ...
      // include "../../../data/tambahDataNilai.php";
        ...
        include "../../../data/launchPoinBulanEvaluator.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Manajemen Penilaian</li>
                                </ul>
                            
                                <!-- <p align="right">
                                    <a href="#tambah" data-toggle='modal'><button type="submit" class="btn btn-small"><i class="icon-plus-sign"></i>&nbsp;Tambah Data Poin</button></a>                                
                                </p> -->   
                                ...
                                <tbody>
                                    <?php
                                    include "../../../data/view/daftarNilaiViewEvaluator.php";
                                    ?>
                                </tbody>
                            </table>
                            ...
                            <?php
                               ...
                               // include "../../../data/view/deleteDataNilaiModal.php";
                                include "../../../data/view/launchPoinBulanViewEvaluator.php";
                            ?>
                        </div>
                    </div>
                </div>
