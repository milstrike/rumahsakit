...
<html>
    <head>
        ...
        include "../../../data/tambahDaftarKepanitiaan.php";
        include "../../../data/editDaftarKepanitiaan.php";
        include "../../../data/deleteDaftarKepanitiaan.php";
        include "../../../data/pagingKepanitiaan.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Daftar Kepanitiaan</li>
                                </ul>
                            
                                <p align="right">
                                    <a href="#tambah" data-toggle='modal'><button type="submit" class="btn btn-small"><i class="icon-plus-sign"></i>&nbsp;Tambah Kepanitiaan</button></a>                                
                                </p>    
                                ...
                                <thead>
                                    <tr id="theadBasic">
                                        ...
                                        <td width="20%" id="thead">Nama Kepanitiaan</td>
                                        <td width="40%" id="thead">Detail Kepanitiaan</td>
                                        <td width="40%" id="thead">Aksi</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    include "../../../data/view/daftarKepanitiaanView.php";
                                    ?>
                                </tbody>
                            </table>
                            ...
                            <?php
                                ...
                                include "../../../data/view/tambahDaftarKepanitiaanViewModal.php";
                                include "../../../data/view/editDaftarKepanitiaanViewModal.php";
                                include "../../../data/view/deleteDaftarKepanitiaanView.php";
