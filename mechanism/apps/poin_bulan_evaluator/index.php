...
<html>
    <head>
        ...
        include "../../../data/pindahIKIPEvaluator.php";
        include "../../../data/pindahIKUKPEvaluator.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Edit Poin Pegawai Bulan: <?php echo $_SESSION['waktu']?></li>
                                </ul>
                                ...
                                <table>
                                  ...
                                  <!--      <td>
                                    ...
                                    <button type='submit' id='isiTabel' name='isiTabel' class="btn btn-small"><i class="icon-list-alt"></i>&nbsp;Isi Tabel</button><br/>
                                        ...
                                        <td>
                                            <form action='' method='post'>
                                                <button type='submit' id='finalisasiData' name='finalisasiData' class="btn btn-warning btn-small" title="Finalisasi data dilakukan oleh Admin" disabled="disabled"><i class="icon-ok-sign"></i>&nbsp;Finalisasi Data</button><br/>
                                </form>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <thead>
                                    <tr id="theadBasic">
                                        ...
                                        <td width="70%" id="thead">Nama Pegawai</td>
                                        <td width="20%" id="thead">Aksi</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    include "../../../data/view/daftarPoinPegawaiViewEvaluator.php";
                                    ?>
                                </tbody>
                            </table>
