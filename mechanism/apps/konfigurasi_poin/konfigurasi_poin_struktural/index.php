                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Konfigurasi Poin: Struktural</li>
                                </ul>
                            
                                <p align="right">
                                    <a href="#tambah" data-toggle='modal'><button type="submit" class="btn btn-small"><i class="icon-plus-sign"></i>&nbsp;Tambah Data Struktural</button></a>                                
                                </p>    
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/strukturalView.php";
                            ...
                            <?php
                                include "../../../../data/view/tambahStrukturalViewModal.php";
                                include "../../../../data/view/editStrukturalViewModal.php";
                                include "../../../../data/view/deleteStrukturalModal.php";
                            ?>
                        </div>
                    </div>
                </div>
