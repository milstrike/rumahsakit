...
<html>
    <head>
        ...
        include "../../../../data/tambahEmergency.php";
        include "../../../../data/EditEmergency.php";
        include "../../../../data/deleteEmergency.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Konfigurasi Poin: Tingkat Emergensi</li>
                                </ul>
                            
                                <p align="right">
                                    <a href="#tambah" data-toggle='modal'><button type="submit" class="btn btn-small"><i class="icon-plus-sign"></i>&nbsp;Tambah Data Tingkat Emergensi</button></a>                                
                                </p>    
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/emergencyView.php";
                            ...
                            <?php
                                include "../../../../data/view/tambahEmergencyViewModal.php";
                                include "../../../../data/view/editEmergencyViewModal.php";
                                include "../../../../data/view/deleteEmergencyModal.php";
                            ?>
                        </div>
                    </div>
                </div>
