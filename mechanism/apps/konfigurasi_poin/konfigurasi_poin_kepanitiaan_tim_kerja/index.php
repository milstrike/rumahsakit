...
<html>
    <head>
        ...
        include "../../../../data/tambahKepanitiaan.php";
        include "../../../../data/EditKepanitiaan.php";
        include "../../../../data/deleteKepanitiaan.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Konfigurasi Poin: Kepanitiaan Tim Kerja</li>
                                </ul>
                            
                                <p align="right">
                                    <a href="#tambah" data-toggle='modal'><button type="submit" class="btn btn-small"><i class="icon-plus-sign"></i>&nbsp;Tambah Data Kepanitiaan Tim Kerja</button></a>                                
                                </p>    
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/kepanitiaanView.php";
                            ...
                            <?php
                                include "../../../../data/view/tambahKepanitiaanViewModal.php";
                                include "../../../../data/view/editKepanitiaanViewModal.php";
                                include "../../../../data/view/deleteKepanitiaanModal.php";
                            ?>
                        </div>
                    </div>
                </div>
