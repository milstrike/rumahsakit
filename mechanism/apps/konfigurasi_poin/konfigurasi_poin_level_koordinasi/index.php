...
<html>
    <head>
        ...
        include "../../../../data/tambahKoordinasi.php";
        include "../../../../data/editKoordinasi.php";
        include "../../../../data/deleteKoordinasi.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Konfigurasi Poin: Level Koordinasi</li>
                                </ul>
                            
                                <p align="right">
                                    <a href="#tambah" data-toggle='modal'><button type="submit" class="btn btn-small"><i class="icon-plus-sign"></i>&nbsp;Tambah Data Level Koordinasi</button></a>                                
                                </p>    
                                ...
                                <thead>
                                    <tr id="theadBasic">
                                        ...
                                        <td width="30%" id="thead">Jumlah Bawahan</td>
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/koordinasiView.php";
                            ...
                            <?php
                                include "../../../../data/view/tambahKoordinasiViewModal.php";
                                include "../../../../data/view/editKoordinasiViewModal.php";
                                include "../../../../data/view/deleteKoordinasiModal.php";
                            ?>
                        </div>
                    </div>
                </div>
