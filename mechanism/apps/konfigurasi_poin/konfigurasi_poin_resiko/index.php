...
<html>
    <head>
        ...
        include "../../../../data/tambahResiko.php";
        include "../../../../data/EditResiko.php";
        include "../../../../data/deleteResiko.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Konfigurasi Poin: Resiko</li>
                                </ul>
                            
                                <p align="right">
                                    <a href="#tambah" data-toggle='modal'><button type="submit" class="btn btn-small"><i class="icon-plus-sign"></i>&nbsp;Tambah Data Resiko</button></a>                                
                                </p>    
                            ...
                            <?php
                                include "../../../../data/view/tambahResikoViewModal.php";
                                include "../../../../data/view/editResikoViewModal.php";
                                include "../../../../data/view/deleteResikoModal.php";
                            ?>
                        </div>
                    </div>
                </div>
