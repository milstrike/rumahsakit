...
<html>
    <head>
        ...
        include "../../../../data/tambahPendidikan.php";
        include "../../../../data/editPendidikan.php";
        include "../../../../data/deletePendidikan.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Konfigurasi Poin: Pendidikan</li>
                                </ul>
                            
                                <p align="right">
                                    <a href="#tambah" data-toggle='modal'><button type="submit" class="btn btn-small"><i class="icon-plus-sign"></i>&nbsp;Tambah Data Pendidikan</button></a>                                
                                </p>    
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/pendidikanView.php";
                            ...
                            <?php
                                include "../../../../data/view/tambahPendidikanViewModal.php";
                                include "../../../../data/view/editPendidikanViewModal.php";
                                include "../../../../data/view/deletePendidikanModal.php";
                            ?>
                        </div>
                    </div>
                </div>
