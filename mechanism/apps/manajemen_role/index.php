                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                ...
                                <dl class="dl-horizontal">
                                    <a href="system_role/">
                                    <dt>System Role</dt>
                                    <dd>Konfigurasi role untuk user yang berhubungan dengan sistem.</dd>
                                    </a>
                                    
                                    <a href="advanced_role/">
                                    <dt>Advanced Role</dt>
                                    <dd>Konfigurasi role untuk user yang berhubungan dengan hak yang lebih spesifik.</dd>
                                    </a>
