...
<html>
    <head>
        ...
        include "../../../../data/editRole.php";
        include "../../../../data/pindahEditRole.php";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Advanced Role</li>
                                </ul>
                                ...
                                <thead>
                                    <tr id="theadBasic">
                                        ...
                                        <td width="20%" id="thead">tingkatan</td>
                                        <td width="30%" id="thead">parameter</td>
                                        <td width="10%" id="thead">aksi</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    include "../../../../data/view/viewAdvancedUser.php";
                                    ?>
                                </tbody>
                            </table>
