                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span9 bigPanel boxShadow" id="bigPanel">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">System Role</li>
                                </ul>
                            
                                <p align="right">
                                    <a href="#" data-toggle='modal'><button type="submit" class="btn btn-small disabled"><i class="icon-plus-sign"></i>&nbsp;Tambah User Role</button></a>                                
                                </p>    
                                ...
                                <tbody>
                                    <?php
                                    include "../../../../data/view/roleView.php";
