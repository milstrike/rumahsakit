...
$poinKepegawaian=$_POST['poinKepegawaian'];


$sqlx = "UPDATE u6799722_rumahsakit.a_2_kepegawaian SET keterangan='$keteranganKepegawaian', poin='$poinKepegawaian' WHERE a_2_kepegawaian.id='$id'";
