        ...
        echo 
            ...
            <div class='modal-body'>
                <form class='form-horizontal' action='' method='post'>
                                ...
                                <div class='control-group'>
                                    <label class='control-label' for='poinKepegawaian'>Persen Pajak*</label>
                                    <div class='controls'>
                                        <input id='poinKepegawaian' name='poinKepegawaian' type='text' required='required' value='".$pajakView."'>
                                    </div>
                                </div>
                                <div class='control-group'>
