...
$counter = 1;
$sql = "select * from c_1_resiko";
$query = mysql("u6799722_rumahsakit", "select * from c_1_resiko");
    ...
    while($row = mysql_fetch_assoc($query)){
        ...
        echo 
            ...
            <div class='modal-body'>
                ...
                <p align='center'>
                Apakah Anda yakin ingin menghapus data untuk resiko: <strong>".$keterangan."</strong> dengan nilai poin <strong>".$poin."</strong>?. Anda tidak bisa mengembalikan lagi data yang sudah dihapus!
                </p>
                <p align='right'>
