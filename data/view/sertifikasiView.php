...
$counter = 1;
$sql = "select * from b_2_sertifikasi ORDER BY b_2_sertifikasi.poin ASC";
$query = mysql("u6799722_rumahsakit", "select * from b_2_sertifikasi ORDER BY b_2_sertifikasi.poin ASC");
