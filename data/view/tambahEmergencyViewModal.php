 ...
 */
        ...
        echo 
            ...
            <h3 id='myModalLabel' style='color: #fff;'>Tambah Data Emergensi</h3>
            </div>
            <div class='modal-body'>
                <form class='form-horizontal' action='' method='post'>
                                ...
                                <div class='control-group'>
                                    ...
                                    <div class='controls'>
                                        <button type='submit' id='submitTambah' name='submitTambah' class='btn btn-primary'><i class='icon-plus-sign icon-white'></i>&nbsp;<strong>Tambah Data Emergensi!</strong></button><br/>
                                    </div>
                                </div>
                                    </form>
            </div>
