    ...
    while($row = mysql_fetch_assoc($query)){
        ...
        echo 
           "<form action='' method='post'>
            ...
            <input id='id_ikip' name='id_ikip' type='text' class='uneditable-input' value='".$id."' style='display:none;'>
            <button type='submit' id='check' name='check' class='btn btn-warning btn-small' title='Simpan Data'><i class='icon-ok-circle icon-white'></i></button>
            </td>
            </tr>
            </form>
            ";
