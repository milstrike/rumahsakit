...
$query = mysql("u6799722_rumahsakit", "select * from perangkat_rs");
...
if($rows > 0){
    while($row = mysql_fetch_assoc($query)){
        ...
        echo 
            ...
            <h3 id='myModalLabel' style='color: #fff;'>Hapus Data Perangkat Rumah Sakit</h3>
            </div>
            <div class='modal-body'>
                <form action='' method='post'>
                <input id='id' name='id' type='text' class='uneditable-input' value='".$id."' style='display:none;'>
                <p align='center'>
                Apakah Anda yakin ingin menghapus data untuk Perangkat Rumah Sakit: <strong>".$keterangan."</strong> dengan level resiko <strong>".$level_risk."</strong> dan level emergensi <strong>".$level_emergency."</strong>?. Anda tidak bisa mengembalikan lagi data yang sudah dihapus!
                </p>
                <p align='right'>
