...
$query = mysql("a3821629_rs", "select * from user_role");
...
if($rows > 0){
    while($row = mysql_fetch_assoc($query)){
        ...
        echo 
            ...
            <h3 id='myModalLabel' style='color: #fff;'>Edit Data Role</h3>
            </div>
            <div class='modal-body'>
                <form class='form-horizontal' action='' method='post'>
                                ...
                                <div class='control-group'>
                                    ...
                                    <div class='controls'>
                                        <input id='role' name='role' type='text' required='required' value='".$namaRole."'>
                                    </div>
                                </div>
                                <div class='control-group'>
                                    <label class='control-label' for='keterangan'>Keterangan*</label>
                                    <div class='controls'>
                                        <textarea rows='5' id='keterangan' name='keterangan' type='text' required='required'>".$keterangan."</textarea>
                                    </div>
                                </div>
                                <div class='control-group'>
