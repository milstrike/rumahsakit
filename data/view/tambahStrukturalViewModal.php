            ...
            <div class='modal-body'>
                <form class='form-horizontal' action='' method='post'>
                                <div class='control-group'>
                                    ...
                                    <div class='controls'>
                                        <input id='keterangan' name='keterangan' type='text' required='required' placeholder='Contoh: KEPALA RUANG'>
                                    </div>
                                </div>
                                <div class='control-group'>
                                ...
                                <div class='control-group'>
                                    ...
                                    <div class='controls'>
                                        <button type='submit' id='submitTambah' name='submitTambah' class='btn btn-primary'><i class='icon-plus-sign icon-white'></i>&nbsp;<strong>Tambah Data Struktural!</strong></button><br/>
                                    </div>
                                </div>
                                    </form>
            </div>
