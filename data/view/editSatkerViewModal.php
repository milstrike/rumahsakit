...
$query = mysql("a3821629_rs", "select * from satker");
...
if($rows > 0){
    while($row = mysql_fetch_assoc($query)){
        ...
        echo 
            ...
            <h3 id='myModalLabel' style='color: #fff;'>Edit Data Satuan Kerja</h3>
            </div>
            <div class='modal-body'>
                <form class='form-horizontal' action='' method='post'>
                                ...
                                <div class='control-group'>
                                    ...
                                    <div class='controls'>
                                        <input id='satker' name='satker' type='text' required='required' value='".$satker."'>
                                    </div>
                                </div>
                                <div class='control-group'>
