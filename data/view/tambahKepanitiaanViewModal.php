 ...
 */
        ...
        echo 
            ...
            <h3 id='myModalLabel' style='color: #fff;'>Tambah Data Kepanitiaan</h3>
            </div>
            <div class='modal-body'>    
                <form class='form-horizontal' action='' method='post'>
                                <div class='control-group'>
                                    ...
                                    <div class='controls'>
                                        <input id='keterangan' name='keterangan' type='text' required='required' placeholder='Contoh: KETUA PANITIA'>
                                    </div>
                                </div>
                                <div class='control-group'>
