...
if($rows > 0){
    while($row = mysql_fetch_assoc($query)){
        ...
        echo 
            ...
            <h3 id='myModalLabel' style='color: #fff;'>Hapus Data Poin</h3>
            </div>
            <div class='modal-body'>
                ...
                <p align='center'>
                Apakah Anda yakin ingin menghapus data poin bulan <strong>".$waktu."</strong>?. Anda tidak bisa mengembalikan lagi data yang sudah dihapus!
                </p>
                <p align='right'>
                <button type='submit' id='submitDelete' name='submitDelete' class='btn btn-danger'><i class='icon-remove icon-white'></i>&nbsp;<strong>Hapus Data Poin!</strong></button><br/>
                </p>
                </form>
            </div>
            </div>";
