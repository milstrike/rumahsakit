 ...
 */
        ...
        echo 
            "
            <div id='tambahMasaKerja' class='modal hide fade' tabindex='-1' role='dialog' aria-labelledby='tambahMasaKerja' aria-hidden='true'>
            ...
            <div class='modal-body'>
                <form class='form-horizontal' action='' method='post'>
                                <div class='control-group'>
                                    ...
                                    <div class='controls'>
                                        <input id='keteranganMasaKerja' name='keteranganMasaKerja' type='text' required='required' placeholder='Contoh: 4 s/d < 8 Th'>
                                    </div>
                                </div>
                                <div class='control-group'>
