...
$counter = 1;
$sql = "select * from b_1_pendidikan";
$query = mysql("u6799722_rumahsakit", "select * from b_1_pendidikan");
    ...
    while($row = mysql_fetch_assoc($query)){
        ...
        echo 
            ...
            <div class='modal-body'>
                ...
                <p align='center'>
                Apakah Anda yakin ingin menghapus data untuk pendidikan: <strong>".$keterangan."</strong> dengan nilai poin <strong>".$poin."</strong>?. Anda tidak bisa mengembalikan lagi data yang sudah dihapus!
                </p>
                <p align='right'>
