...
if($rows > 0){
    while($row = mysql_fetch_assoc($query)){
        ...
        echo 
            "
            <div id='editKepegawaian".$counter."' class='modal hide fade' tabindex='-1' role='dialog' aria-labelledby='editKepegawaian".$counter."' aria-hidden='true'>
            <div class='modal-header' style='background-color: #149bdf;'>
            <button type='button' class='close' data-dismiss='modal' aria-hidden='true'>×</button>
            <h3 id='myModalLabel' style='color: #fff;'>Edit Kepegawaian</h3>
            </div>
            <div class='modal-body'>
                <form class='form-horizontal' action='' method='post'>
                                ...
                                <div class='control-group'>
                                    ...
                                    <div class='controls'>
                                        <input id='keteranganKepegawaian' name='keteranganKepegawaian' type='text' required='required' value='".$keteranganView."'>
                                    </div>
                                </div>
                                <div class='control-group'>
                                    <label class='control-label' for='poinKepegawaian'>Poin Kepegawaian*</label>
                                    <div class='controls'>
                                        <input id='poinKepegawaian' name='poinKepegawaian' type='text' required='required' value='".$poinView."'>
                                    </div>
                                </div>
                                <div class='control-group'>
